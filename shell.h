...
/* rep_var.c */
void check_env(r_var **h, char *in, data *data);
int check_vars(r_var **h, char *in, char *st, data *data);
char *replaced_input(r_var **head, char *input, char *new_input, int nlen);
char *rep_var(char *input, data *database);
...
/* get_builtin */
int (*get_builtin(char *cmd))(data *database);
...
/* aux_error1.c */
char *strcat_cd(data *, char *, char *, char *);
